...
import ax.dkarlsso.game_management.features.S3StorageFeature;
import ax.dkarlsso.game_management.games.Enshrouded;
import ax.dkarlsso.game_management.games.Valheim;
        ...
        final List<GameServerStack> gameServerStacks = List.of(
                GameServerStack.create(app, props,
                        Enshrouded.builder()
                                ...
                                .serverPassword("banan") // Should come from SecretsManager
                                .gameServerId("enshrouded")
                                .instanceType(InstanceType.of(InstanceClass.BURSTABLE3, InstanceSize.LARGE))
                                .build(),
                        List.of(new Route53Feature(zoneAttributes, "enshrouded.dkarlsso.com"), new S3StorageFeature()),
                        List.of("eu-north-1c")),
                GameServerStack.create(app, props,
                        Valheim.builder()
                                .serverName("Ronheim")
                                ...
                                .instanceType(InstanceType.of(InstanceClass.BURSTABLE3, InstanceSize.LARGE))
                                .build(),
                        List.of(new Route53Feature(zoneAttributes, "ronheim.dkarlsso.com"), new S3StorageFeature()),
                        List.of("eu-north-1c")),
                ...
                GameServerStack.create(app, props,
                        Valheim.builder()
                                ...
                                //.instanceType(InstanceType.of(InstanceClass.C7A, InstanceSize.XLARGE))
                                .instanceType(InstanceType.of(InstanceClass.BURSTABLE3, InstanceSize.XLARGE))
                                .build(),
                        List.of(new Route53Feature(zoneAttributes, "valheim.dkarlsso.com"), new S3StorageFeature()),
                        List.of("eu-north-1c"))
        );
